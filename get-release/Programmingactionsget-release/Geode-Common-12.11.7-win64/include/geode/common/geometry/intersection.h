...
namespace geode
{
    ...
    using CorrectnessInfo = std::pair< bool, bool >;
    ...
    struct IntersectionResult
    {
        ...
        IntersectionResult(
            Intersection intersection, CorrectnessInfo correctness_info )
            : result( std::move( intersection ) ),
              type( IntersectionType::INTERSECT ),
              correctness( std::move( correctness_info ) )
        {
            if( !correctness.first || !correctness.second )
            {
        ...
        CorrectnessInfo correctness{ false, false };
    };
    ...
    IntersectionResult< Point3D >
        geode_common_geometry_api line_plane_intersection(
     ...
     */
    IntersectionResult< Point3D >
        geode_common_geometry_api segment_plane_intersection(
     ...
     */
    IntersectionResult< Point3D >
        geode_common_geometry_api segment_triangle_intersection(
     ...
     */
    IntersectionResult< Point3D >
        geode_common_geometry_api line_triangle_intersection(
            const InfiniteLine3D& line, const Triangle3D& triangle );

    /*!
     * Compute the intersection(s) between a circle and a plane
     * @return an optional of the intersection points.
     * @warning if the circle is included in the plane nothing is returned
     * XXXXXXXXXXXXXXXXXXX todo check XXXXXXXXXXXXXXXXXXXXXXXx
     */
    IntersectionResult< absl::InlinedVector< Point3D, 2 > >
        geode_common_geometry_api circle_plane_intersection(
            const Circle& circle, const Plane& plane );

    /*!
     * Compute the intersection between a disk and a segment
     * @return an optional of the intersection point.
     * @warning if the segment is included in the disk plane nothing is returned
     */
    IntersectionResult< Point3D > geode_common_geometry_api
        segment_disk_intersection( const Segment3D& segment, const Disk& disk );

    /*!
     * Compute the intersection(s) between a circle and a triangle
     * @return an optional of the intersection points.
     * @warning if the triangle and the circle belong to the same plane nothing
     * is returned
     * XXXXXXXXXXXXXXXXXXX todo check XXXXXXXXXXXXXXXXXXXXXXXx
     */
    IntersectionResult< absl::InlinedVector< Point3D, 2 > >
        geode_common_geometry_api triangle_circle_intersection(
     ...
     */
    IntersectionResult< InfiniteLine3D > geode_common_geometry_api
    ...
    IntersectionResult< Point2D >
        geode_common_geometry_api line_line_intersection(
     ...
     */
    IntersectionResult< Point2D >
        geode_common_geometry_api segment_segment_intersection(
     ...
     */
    IntersectionResult< Point2D >
        geode_common_geometry_api segment_line_intersection(
